...
/**
  ...
  nohup spark-submit --class org.jd.datamill.rec.train.TestFurtureOneData \
--master yarn \
--deploy-mode client \
--num-executors 256 \
--executor-memory 8G \
...
hdfs://ns1018/user/jd_ad/ads_polaris/zhangwenxiang6/user_score_model/wd_v2/data_train_and_test_20190107_1dt_all_type_reduced \
hdfs://ns1018/user/jd_ad/ads_polaris/zhangwenxiang6/user_score_model/wd_v2/xgb_model_all_reduced/bestmodel_depth8_tree200 \
> logs/rec_TestFurtureOneData_predict_all_reduced_20190220.log 2>&1 &


  */
object TestFurtureOneData {
